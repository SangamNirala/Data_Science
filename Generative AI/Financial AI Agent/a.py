...
GROQ_API_KEY = st.secrets["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"]["api_key"]
...
def main():
    ...
    # Main content
    st.markdown('<h1 class="stock-header">🤖 Advanced Stock Market Analysis </h1>', 
                unsafe_allow_html=True)
